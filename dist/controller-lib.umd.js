(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('node-jose'), require('crypto')) :
    typeof define === 'function' && define.amd ? define(['exports', 'node-jose', 'crypto'], factory) :
    (factory((global.library = {}),global.jose,global.crypto));
}(this, (function (exports,jose,crypto) { 'use strict';

    var jose__default = 'default' in jose ? jose['default'] : jose;
    ...
    class Integrity {
        ...
        signPublicKey(key) {
            ...
            return key.getPrivateKey(this.secret)
                .then(privateKey => jose.JWS.createSign({ format: 'flattened' }, { key: privateKey, reference: 'jwk' })
...
//# sourceMappingURL=controller-lib.umd.js.map
