...
class Integrity {
    ...
    signPublicKey(pubKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let jws = yield JWS.createSign({ format: 'flattened' }, { key: privateKey, reference: 'jwk' }).update(JSON.stringify(pubKey), 'utf8').final();
            return jws;
        });
    }
    deleteKey(kid) {
    ...
    parseSignedRealm(name, jws, importKey = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let pubKey = yield JWK.asKey(obj.publicKey, 'json');
...
//# sourceMappingURL=integrity.es5.js.map
